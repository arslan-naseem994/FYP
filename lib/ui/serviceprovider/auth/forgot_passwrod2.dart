...
class _ForgotPasswordScreen2State extends State<ForgotPasswordScreen2> {
  ...
  final int _countdownDuration = 5; // 1 minute in seconds
  Timer? _countdownTimer;
  int _remainingSeconds = 0;
  final String _prefsKeyRemainingSeconds = 'remainingSeconds';
  final String _prefsKeyIsButtonEnabled = 'isButtonEnabled';
  ...
  Future<void> _loadTimerState() async {
    ...
    setState(() {
      _remainingSeconds = _prefs?.getInt(_prefsKeyRemainingSeconds) ?? 0;
      _isButtonEnabled = _prefs?.getBool(_prefsKeyIsButtonEnabled) ?? true;
    });
  ...
  Future<void> _saveTimerState() async {
    await _prefs?.setInt(_prefsKeyRemainingSeconds, _remainingSeconds);
    await _prefs?.setBool(_prefsKeyIsButtonEnabled, _isButtonEnabled);
  }
