...
class RecentBookingDetailsScreen extends StatefulWidget {
  ...
  const RecentBookingDetailsScreen({
    super.key,
  ...
  @override
  State<RecentBookingDetailsScreen> createState() =>
      _RecentBookingDetailsScreenState();
}

class _RecentBookingDetailsScreenState
    extends State<RecentBookingDetailsScreen> {
