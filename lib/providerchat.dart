...
class ProviderChatScreenDetails extends StatefulWidget {
  const ProviderChatScreenDetails({super.key});

  @override
  State<ProviderChatScreenDetails> createState() =>
      _ProviderChatScreenDetailsState();
}

class _ProviderChatScreenDetailsState extends State<ProviderChatScreenDetails> {
