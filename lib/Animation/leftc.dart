...
class LeftCAnimation extends StatefulWidget {
  final Widget child;

  const LeftCAnimation({required this.child});

  @override
  _LeftCAnimationState createState() => _LeftCAnimationState();
}

class _LeftCAnimationState extends State<LeftCAnimation>
