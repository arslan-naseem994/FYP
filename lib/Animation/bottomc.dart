...
class BottomCAnimation extends StatefulWidget {
  final Widget child;

  const BottomCAnimation({required this.child});

  @override
  _BottomCAnimationState createState() => _BottomCAnimationState();
}

class _BottomCAnimationState extends State<BottomCAnimation>
