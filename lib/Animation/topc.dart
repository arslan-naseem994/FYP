...
class TopCAnimation extends StatefulWidget {
  final Widget child;

  const TopCAnimation({required this.child});

  @override
  _TopCAnimationState createState() => _TopCAnimationState();
}

class _TopCAnimationState extends State<TopCAnimation>
