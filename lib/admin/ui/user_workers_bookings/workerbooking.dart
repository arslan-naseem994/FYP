...
class WorkerBookingDetails extends StatefulWidget {
  final String providerid;
  const WorkerBookingDetails({super.key, required this.providerid});

  @override
  State<WorkerBookingDetails> createState() => _WorkerBookingDetailsState();
}

class _WorkerBookingDetailsState extends State<WorkerBookingDetails> {
  int totalUsers = 0;
  String username = '';
